    ...
    while (true) {
        ...
        try {
            ...
            if (res.statusCode == 200) {
                ...
                // }
                // 备份错误图片
                let pic = images.read("./tmp/pic.png");
                images.save(pic, "./tmp/pic_error.png");
                pic.recycle();
...
function 解锁(button) {
    ...
    if (!ddjs && !jpso) {
        ...
        sleep(600);
        log("解锁最后一个：" + click(dwidth * 0.88, dheight * 0.63));
        click(dwidth * 0.88, dheight * 0.53);
        click(dwidth * 0.88, dheight * 0.43);
        // 关闭提示
        sleep(666);
        for (i = 0; i < 5; i++) {
        ...
        sleep(3000);
        log("再解锁一个：" + click(dwidth * 0.13, dheight * 0.63));
        click(dwidth * 0.13, dheight * 0.53);
        click(dwidth * 0.13, dheight * 0.43);

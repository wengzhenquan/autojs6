...
**1. 先授权AutoJs6需要的权限。**  
   ...
   ``` 
   小米手机：AutoJs6→应用详情→权限管理→其它权限→后台弹出界面。  
   华为手机：听说有。
...
**10. 你还在等什么？哪来的9？赶快启动试试啊！成功了就定时任务甩起！**   
   ...
   **APP打包版本下载地址？**   
   ...
   仅适配：1080x2400、1200x2670、1220x2712、1440x2960、1440x3200
...
（好累啊，这几天连发好几个版，脑袋晕乎乎的了，饭都来不及吃。）
（好了，一天没吃饭，去泡泡面了……）
（长大后……含泪偷偷吃泡面……(-̩̩̩-̩̩̩-̩̩̩-̩̩̩-̩̩̩___-̩̩̩-̩̩̩-̩̩̩-̩̩̩-̩̩̩) ）

...
--- 
### **社区APP下载 **(支持跳转小程序版)** ：**  
版本很多，但不一定兼容你的手机，社区APP若打不开、白屏或者有问题就换个版本。  
...
### **1. 先授权AutoJs6需要的权限。**  
   ...
   **最后一个(投影媒体)权限需要Shizuku或root才能开启！**   
...
### **3. 将脚本解压到工作路径下。**  
   ...
   * 只需 **【小社脚本】一键更新程序.js**或者 **【小社脚本】启动程序.js**文件，即可自动下载所有文件。
...
### **5. 编辑配置文件`config.js`：**  
   ...
   * 配置文件里面都有详细说明：  
     ...
     * **数字(或混合)密码：** 将“解锁方式”改成2
       ...
       * **混合密码(测试)** ：“000000”改成你的混合密码，仅支持 **数字和小写字母** 组合。
...
![image](说明/定时任务.jpg)  
  ...
  * 保证全自动化进行，必须打开 ****“投影媒体权限”****！（shizuku或者root）   
   想流程减少错误，请确保AutoJs6拥有 ****“后台弹出界面”权限****！   

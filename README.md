...
## 问题收集：
   ...
   **4. 要开始使用AutoJs6录制或投放内容吗？每次需要手动点“立即开始”。**  
   ...
   **5. 方法images.requestScreenCapture()调用失败。**  
   （截图权限无法通过）
   ...
   **7. 为什么小程序打开了没有动作？为什么不会自动打开“小米社区”APP？**  

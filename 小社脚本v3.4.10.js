    ...
    if (wait(() => register.exists(), 4, 600)) {
        ...
        if (checkBox.click()) {
            ...
            if (qd) {
                ...
                //位置在右下角
                for (i = 0; i < 5; i++) {
                    click(dwidth * 0.734, dheight * (0.86 + 0.006 * i));
                    sleep(50);
                }
            }
            sleep(1500)
...
function mhqdClick() {
    ...
    if (config.小程序签到坐标) {
        ...
        for (i = 0; i < 15; i++) {
            click(dwidth * 0.78, dheight * (0.46 + 0.004 * i));
            click(dwidth * 0.817, dheight * (0.46 + 0.004 * i));
            click(dwidth * 0.84, dheight * (0.46 + 0.004 * i));
            click(dwidth * 0.87, dheight * (0.46 + 0.004 * i));
            sleep(50);
        }
    }

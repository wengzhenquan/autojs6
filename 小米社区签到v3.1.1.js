...
function unLock() {
    ...
    log("开始解锁设备……");
    // if (swipe(dwidth * 1 / 2, dheight * 0.98, dwidth * 1 / 2, dheight * 1 / 2, 500)) {
    //     log("上滑成功！");
    // } else {
    //     gesture(500, [dwidth * 1 / 2, dheight * 0.98], [dwidth * 1 / 2, dheight * 1 / 2]);
    // }
    //两种方式重复上滑
...
function permissionv() {
    ...
    // // Shizuku权限检测
    // const isShizukuActive = (() => {
    //     try {
    //         const Shizuku = Java.use('moe.shizuku.api.Shizuku');
    //         return Shizuku.getUid() > 0 &&
    //             Shizuku.checkPermission() === 0;
    //     } catch (e) {
    //         return false;
    //     }
    // })();
